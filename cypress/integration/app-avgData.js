...
describe("See average data from the map", () => {
    ...
    it("shouldn't show data", () => {
        ...
        cy.intercept('GET', 'http://ontdekstation-service:8082/api/Sensor/average', {}).as("averageData");
        cy.visit("/Map");
    ...
    it("should show data", () => {
        cy.intercept('GET', 'http://ontdekstation-service:8082/api/Sensor/average', {fixture: 'mock_avgData.json'}).as("averageData");
        cy.visit("/Map");
